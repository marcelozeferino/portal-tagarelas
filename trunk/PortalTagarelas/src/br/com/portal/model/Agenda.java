...
public class Agenda implements Serializable{
	...
	@Transient
	private boolean flagParticipando;
		
	
	
	public boolean isFlagParticipando() {
		return flagParticipando;
	}

	public void setFlagParticipando(boolean flagParticipando) {
		this.flagParticipando = flagParticipando;
	}
