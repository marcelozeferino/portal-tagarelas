	...
	<script type="text/javascript">
		function pegaNomeCurto() {
			...
			if (apelido == ""){
				...
				nomeCurto = n[0];
				if(n[0].length){
					nomeCurto = nomeCurto.substring(0,8);
				}
				document.getElementById('input-sobrenome').value = nomeCurto;
			}
		}
	</script>
				...
				<s:form id="formAlteracaoUsuario" name="formAlteracaoUsuario" method="POST" action="/alterarUsuario.do" theme="simple" enctype="multipart/form-data">
					<div class="error"></div>
  					...
  					<div id="inputs">
						...
						<s:textfield id="input-sobrenome" value="%{#session.usuarioLogado.sobrenome}" name="usuario.sobrenome" cssClass="inputGrande" required="true" maxlength="8"/>
