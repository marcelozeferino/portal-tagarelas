...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			/*$('#target').Jcrop({onChange: showPreview,onSelect: showPreview,aspectRatio: 1});*/
	...
	<div id="bannerConteudo">
		<div id="tituloPrincipal">
			...
			<p align="justify">Nesta se&ccedil;&atilde;o est&atilde;o
				listadas as futuras sess&otilde;es de bate-papo que os professores
				agendaram pelo Portal Tagarelas. Cada sess&atilde;o planejada pelo
		...
		<div id="conteudoPagfull">
			<div id="listaSistemas">
				<section>
				<p class="textGrande">
					Sessões Vou Participar<br /> <br />
				</p>
				<div id="sessoesAgendadas">
					<s:iterator value="listaAgendasUsuarioParticipa" var="agenda">
						<div class="menu_list">
							<p class="menu_head">
