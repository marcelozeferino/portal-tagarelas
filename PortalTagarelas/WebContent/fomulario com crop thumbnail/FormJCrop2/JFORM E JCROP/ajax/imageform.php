		  ...
		  if($tam_name[0] > 170){
			...
			if($tam_name[1] > 170){	
			  ...
			  if($move_uploaded_file){
					...
					$del_img = mysql_query("SELECT temp FROM tab_upload WHERE id = '$id_session'") or die("Erro ao consultar");
					...
					mysql_query("UPDATE tab_upload SET temp = '$actual_image_name' WHERE id = '$id_session'") or die("Erro ao consultar");
