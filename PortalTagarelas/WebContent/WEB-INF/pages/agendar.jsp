			...
			<div id="formCadastro">
				...
				<s:form id="formCadastrarSessao" name="formCadastrarSessao" method="POST" action="/cadastrarAgenda.do" theme="simple">
					<div id="inputs">
						...
						<s:textarea id="campo-descricao" name="agenda.descricao" required="true" rows="4" cols="50"  cssClass="inputGrande" style="height: 200px" title="A descrição é o local onde você pode falar com detalhes sobre o objetivo da sessão."/>
						<br/><br/>
						
						<label for="apelido">Observa&ccedil;&atilde;o</label><br/>
						<s:textarea id="campo-observacao" name="agenda.observacao" rows="4" cols="50"  cssClass="inputGrande" style="height: 200px" title="A descrição é o local onde você pode falar com detalhes sobre o objetivo da sessão."/>
						<br/><br/> 
